...
public class DataToImageWriter implements RecordWriter<Text, BytesWritable>{
	...
	public DataToImageWriter(FileSystem fs, JobConf conf, String name, Progressable progress) throws IOException {
		this.fs = fs;
...
//		System.out.println("WRITE: " + arg0.toString());
		...
		//TODO write to ImagePlus then to disk
